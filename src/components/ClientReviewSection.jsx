  ...
  return (
    <section className="bg-black w-full">
      ...
      <div className="w-full flex justify-center py-[6vw]">
        <div className="client-container sm:justify-between sm:h-fit sm:flex-col md:justify-between md:h-fit md:flex-col w-full px-[2.5vw] border-t  h-[60vh] sm:border-none border-b border-white/30 flex justify-between">
