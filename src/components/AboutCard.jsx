...
const AboutCard = ({ index, data }) => {
  ...
  return (
    <div
      ...
      className={`service-card-${index} service-cards text-center about-cards relative z-[1] bg-black w-[24%] text-white rounded-lg shadow-md p-[1vw] py-[2vw] border-[2px] border-white/30`}
    >
